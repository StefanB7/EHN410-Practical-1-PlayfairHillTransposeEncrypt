...
print("Key: RRFVSVCCT")
print("\nOutput:")
txtENC = verander_die.Playfair_Encrypt("RRFVSVCCT","The following symbols should not be encrypted: @,#,$,%,^,*,&,*,1,2,3,4.")
print("Encrypted text: ",txtENC)
txtDEC = verander_die.Playfair_Decrypt("RRFVSVCCT",txtENC)
print("Decrypted text: ",txtDEC)
