...
print("Key: bigapple")
print("\nOutput:")
txtENC = EHN_Group7.Transpose_Encrypt("bigapple",1,"jeep")
print("Encrypted text: ",txtENC)
txtDEC = EHN_Group7.Transpose_Decrypt("bigapple",1,txtENC)
...
print("Key: bigapple")
print("\nOutput:")
txtENC = EHN_Group7.Transpose_Encrypt("bigapple",1,"this sentence is not long enough")
print("Encrypted text: ",txtENC)
txtDEC = EHN_Group7.Transpose_Decrypt("bigapple",1,txtENC)
print("Decrypted text: ",txtDEC)
...
print("Key: bigapple")
print("\nOutput:")
txtENC = EHN_Group7.Transpose_Encrypt("bigapple",1,"The following symbols should not be encrypted: @,#,$,%,^,*,&,*,1,2,3,4.")
print("Encrypted text: ",txtENC)
txtDEC = EHN_Group7.Transpose_Decrypt("bigapple",1,txtENC)
print("Decrypted text: ",txtDEC)
...
print("Key: bigapple")
print("\nOutput:")
txtENC = EHN_Group7.Transpose_Encrypt("bigapple",1,"that's a fat cat")
print("Encrypted text: ",txtENC)
txtDEC = EHN_Group7.Transpose_Decrypt("bigapple",1,txtENC)
print("Decrypted text: ",txtDEC)
...
print("Key: bigapple")
print("\nOutput:")
txtENC = EHN_Group7.Transpose_Encrypt("bigapple",2,"that's a fat cat")
print("Encrypted text: ",txtENC)
txtDEC = EHN_Group7.Transpose_Decrypt("bigapple",2,txtENC)
print("Decrypted text: ",txtDEC)
